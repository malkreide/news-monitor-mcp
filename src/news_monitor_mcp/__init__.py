"""news-monitor-mcp – MCP Server für globales News-Monitoring via WorldNewsAPI."""
...
try:
    ...
    # drift apart: pyproject said 0.3.4, this said 0.3.0. A value nobody
    # has to remember to bump cannot go stale.
    __version__ = _distribution_version("news-monitor-mcp")
